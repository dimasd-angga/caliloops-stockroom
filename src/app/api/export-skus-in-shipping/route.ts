...
import { exportSkusInShippingToSheets, type SkuInShippingRow } from '@/lib/services/googleSheetsService';
...
export async function POST(request: NextRequest) {
    try {
        ...
        console.log('=== API ROUTE RECEIVED SKU DATA ===');
        ...
        const result = await exportSkusInShippingToSheets(
            skuData as SkuInShippingRow[],
            sheetName
        );
